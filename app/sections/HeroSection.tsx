      ...
      <div>
        <div className="relative">
          <div className="w-7/8 relative left-1/2 -translate-x-1/2 ">
            <h1 className="text-5xl font-bold text-center max-w-[427px] mx-auto">Des sites web prêts à <span className="text-primary font-secondary font-normal">performer</span></h1>
        ...
        <div className="hero-image-container relative max-w-4xl mx-auto overflow-hidden rounded-lg mt-2">
          <div className="hidden md:flex md:items-center md:justify-center md:gap-3 w-2/5 absolute top-0 left-1/2 -translate-x-1/2 bg-body-background p-3 text-sm rounded-3xl ">
